...
function geraLink() {
    ...
    let link = "http://localhost/zippyLocal/actions/pagamento/processaPix.php?valorTotal=" + valorTotal + "&PIX=true&ID_PEDIDO=" + idPedido + "&remetente=" + remetente + "&destinatario=" + destinatario + "&chatIdForm=" + chatIdForm + "&pagador=" + pagador;
