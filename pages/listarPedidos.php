...
<div class="container-pedido">
    ...
    <form action="../actions/listar_pedidos.php" method="post">
        ...
        <div class="form-row mt-5">
            ...
            <div class="form-row col-md-5">
                <input type="text" class="form-control" id="destino" name="destino" placeholder="Para: São Paulo - Brazil">
            </div>
...
<h2 class="text-center">Pedidos Disponíveis</h2>
                ...
                <div class="col-sm">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Valor:</strong> R$: <?= $pedido['VALOR_POSTAGEM'] ?></p>
