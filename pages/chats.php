            ...
            <div class="col-lg-8">
                <div class="chat">
                    ...
                    <div class="chat-body">
                            ...
                            if ($result->rowCount() > 0) {
                                ...
                                while ($row = $result->fetchAll(PDO::FETCH_ASSOC)) {
                                    ...
                                    echo "<div class='info-pedido'>
                                                ...
                                                <span>Numero do Pedido: #{$row[0]['ID_POSTAGEM']}</span>
                                                </p>
                                              </div>";
                        ...
                        <p id='disclaimer' class='alert alert-primary' role='alert'>O valor combinado foi de R$ <span class="badge badge-success" id="valorCombinado"></span> Va para o checkout para finalizar o pagamento</p>
                        <div class="mensagens">
