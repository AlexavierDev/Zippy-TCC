                        ...
                        <div class="order-details">
                            ...
                            <div class="order-item">
                                ...
                                <div class="item-info">
                                    ...
                                    <p class="receipt-info"><strong>Pais de destino:</strong> <?= $pedido['PAIS_DESTINO'] ?></p>
        ...
        ?>
            ...
            <div class="payment-form">
                ...
                <div class="payment-methods">
                    <button id="pagamento_cartao" class="payment-method activee"><i class="fa-brands fa-pix"></i> Cartão de crédito</button>
                    <button id="pagamento_pix" class="payment-method" onclick="geraLink()"><i class="fa-regular fa-credit-card"></i> PIX</button>
                </div>
                ...
                <div class="payment-loader" style="display:none;">
                    ...
                    <div class="loader-text">
                        Agurade, estamos processando seu pagamento...
                    </div>
                </div>
                ...
                <div id="cartao">
                    ...
                    C0,17.9,17.9,0,40,0z" />
                                        ...
                                        <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">Numero cartao</text>
                                        <g>
